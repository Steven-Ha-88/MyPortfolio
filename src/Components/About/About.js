    ...
    <Section id='about'>
      <AboutWrapper data-aos='fade-up'>
        ...
        <Description data-aos='fade-right' textAlign='start'>
          Front-end Developer(React/Redux) with Back-end experience (Node.js,
          Express and MongoDB) based in London. My background is in computer
          science with a huge interest in Cloud Services. I enjoy using the
